...
var user_type=el.val();
      ...
      $.ajax({
       url : "<?php echo site_url('index.php/user/Jobs/show_cities')?>/" + user_type,        
       type: "GET",
...
//            alert('Error get data from ajax 1');
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {         
        url = "<?php echo site_url('index.php/user/Jobs/job_add')?>";
      }
      else
      {
        url = "<?php echo site_url('index.php/user/Jobs/job_update')?>";
      }
...
//                alert('Error adding / update data');
    ...
    function delete_job(id)
    {
          ...
          $.ajax({
            url : "<?php echo site_url('index.php/user/Jobs/job_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
