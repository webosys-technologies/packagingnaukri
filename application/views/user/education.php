...
//     }
    ...
    {     
     ...
     $('#form')[0].reset(); // reset form on modals
      ...
      //Ajax Load data from ajax
      $.ajax({
        url : "<?php echo site_url('index.php/user/Education/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {         
        url = "<?php echo site_url('index.php/user/Education/edu_add')?>";
        var data = new FormData(document.getElementById("form"));

      }
      else
      {
        url = "<?php echo site_url('index.php/user/Education/edu_update')?>";
...
//                alert('Error adding / update data');
    ...
    function delete_edu(id)
    {
          ...
          $.ajax({
            url : "<?php echo site_url('index.php/user/Education/edu_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
