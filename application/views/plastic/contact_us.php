		...
		<h5 style="color:#0BA1DC;">Home <i class="fas fa-angle-double-right"></i> Contact Us</h5>
               ...
               <div class="row">
                   <form action="<?php echo base_url()?>Home/send_msg" method="post">
                    <div class="col-md-5 col-md-offset-1">
                                <h4 style="color:#0BA1DC;">Get a Free Consultation</h4><hr style="border-top: 1px solid #ccc;">
					...
					<input class="form-control" name="name" id="fname" minlength="2" required="" type="text"  value="<?php echo set_value('recruiter_fname'); ?>" /><span class="text-danger" id="name_err">
            
          </span><span class="text-danger" id="mobile_err"></span>
