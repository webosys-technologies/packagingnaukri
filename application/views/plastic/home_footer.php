...
<!--        <div class="container">        
  ...
  <a class="carousel-control right" href="#carousel1" data-slide="next">&rsaquo;</a>
      ...
      <div class="footer text-center">
				<div class="container">
					<div class="copy">
		              <p> <strong style="color:white">Copyright &copy; 2018 <?php echo $system->system_name;?>. All rights reserved. </strong><span style="color:#40CDFA;">Developed by <a style="color:#40CDFA;" href="http://webosys.com/" target="_blank">Webosys Technologies</a></span>	</p>
		            </div>
