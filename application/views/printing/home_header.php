...
<!-- Custom Theme files -->
<link href="<?php echo base_url();?>assets/new/css/printing_style.css" rel='stylesheet' type='text/css' />	
...
<body>
   ...
   <a href="https://www.linkedin.com/company/www-packagingnaukri-com" class="fa fa-linkedin icon"></a></p>
			...
			<div class="container">
				<div class="logo">
					 <img src="<?php echo  base_url();?>assets/images/printing_logo.png" width="300x" height="63px">
				</div>
