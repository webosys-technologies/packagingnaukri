...
<style>
    ...
    <div class="row" style="background:#F2F3F4">
      ...
      <div class="footer text-center">
				<div class="container">
		            <div class="copy">
		              <p> <strong style="color:white">Copyright &copy; 2018 <?php echo $system->system_name;?>. All rights reserved. </strong><span style="color:orange">Developed by <a style="color:orange" href="http://webosys.com/" target="_blank">Webosys Technologies</a></span>	</p>
		            </div>
