        ...
        <?php
         ...
         foreach($insti as $res){?>
             <tr>    <!--                    <td><input type="checkbox" name="checked[]"  value="<?php echo $res->member_id; ?>" class="" ></td> --> 
                                       ...
                                       ?></td>
                                       <td>
                  <button class="btn btn-success btn-xs" onclick="edit_insti(<?php echo $res->institute_id; ?>)" id="btn1" data-toggle="tooltip" data-placement="bottom" title="Edit Member"><i class="glyphicon glyphicon-pencil"></i></button>
                  <button class="btn btn-danger btn-xs" onclick="delete_menu(<?php echo $res->institute_id;?>)" data-toggle="tooltip" data-placement="bottom" title="Delete Member"><i class="glyphicon glyphicon-trash"></i></button>
...
//     }
    ...
    {     
     ...
     $('#form')[0].reset(); // reset form on modals
      ...
      //Ajax Load data from ajax
      $.ajax({
        url : "<?php echo site_url('index.php/admin/Institute/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {         
        url = "<?php echo site_url('index.php/admin/Institute/insti_add')?>";
        var data = new FormData(document.getElementById("form"));

      }
      else
      {
        url = "<?php echo site_url('index.php/admin/Institute/insti_update')?>";
...
//                alert('Error adding / update data');
    ...
    function delete_insti(id)
    {
          ...
          $.ajax({
            url : "<?php echo site_url('index.php/admin/Institute/insti_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
