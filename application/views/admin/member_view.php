...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
         <div class="col-md-4">
    <button class="btn btn-primary" onclick="add_student()" data-toggle="tooltip" data-placement="bottom" title="Add Center">      <i class="glyphicon glyphicon-plus"></i> Add Member</button>
        ...
        <?php
         ...
         foreach($members as $res){?>
             <tr>    <!--                    <td><input type="checkbox" name="checked[]"  value="<?php echo $res->center_id; ?>" class="" ></td> --> 
                                       ...
                                       ?></td>
                                       <td>
                  <button class="btn btn-success" onclick="edit_member(<?php echo $res->member_id; ?>)" data-toggle="tooltip" data-placement="bottom" title="Edit Center"><i class="glyphicon glyphicon-pencil"></i></button>
                  <button class="btn btn-danger" onclick="delete_member(<?php echo $res->member_id;?>)" data-toggle="tooltip" data-placement="bottom" title="Delete Center"><i class="glyphicon glyphicon-trash"></i></button>
